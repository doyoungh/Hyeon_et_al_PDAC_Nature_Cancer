...
ind_clus1=cellfun(@str2num,rowlabels_mad20_c5_fix(1:31));
ind_clus2=cellfun(@str2num,rowlabels_mad20_c5_fix(32:58));
ind_clus3=cellfun(@str2num,rowlabels_mad20_c5_fix(59:78));
ind_clus4=cellfun(@str2num,rowlabels_mad20_c5_fix(79:111));
ind_clus5=cellfun(@str2num,rowlabels_mad20_c5_fix(112:end));
...
[peptide_sig_mad20_c5_fix,~]=signature_extractor(5,0.58,0.05,fc_all_mad20_c5_fix,ovp_mad20_c5_fix,peptides_union_exp2,fc_merged_qnorm2_core,ind_Cs_mad20_c5_fix,[]); 
