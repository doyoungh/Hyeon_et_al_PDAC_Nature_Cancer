function normalizedVals = quantilenorm2(values,varargin)
...
med_std_dev=median(nanstd(values));
%[mean_vals,~]=sort(med_std_dev.*trnd(N*2,[N 1]));
[mean_vals,~]=sort(med_std_dev.*randn(N,1));
